...
namespace WebApi.Controllers
{
    ...
    [ApiController]
    public class WarehouseAdoController : ControllerBase
    {
        private readonly IWarehouseAdoRepository _repository;
        public WarehouseAdoController(IWarehouseAdoRepository repository)
        {
